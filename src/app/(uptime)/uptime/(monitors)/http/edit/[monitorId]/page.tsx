...
import { ChangeEvent, FC, ReactElement, use } from "react";

const EditHttpMonitor: FC<EditMonitorProps> = ({ params } : { params: Promise<EditMonitorProps>}): ReactElement => {
  ...
  const {
    ...
    setMonitorInfo,
    onHandleSubmit,
  } = useHttpEdit(parameter.monitorId);
