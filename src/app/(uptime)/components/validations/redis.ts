...
export const redisSchema = z.object({
  ...
  url: z.string({ required_error: 'URL is a required field.' }).includes('redis'),
...
export const redisSchemaValidation = (monitorInfo: IMonitorDocument): IMonitorErrorMessage => {
