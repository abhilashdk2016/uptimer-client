...
export const tcpSchema = z.object({
  ...
  url: z.string({ required_error: 'Hostname is a required field.' }).min(5, { message: 'Hostname is a required field.' }),
...
export const tcpSchemaValidation = (monitorInfo: IMonitorDocument): IMonitorErrorMessage => {
