      ...
      <form action={onLoginSubmit}>
        <div className="mt-12 w-full px-5">
          <div className="mb-5 flex flex-col justify-between text-gray-600">
            ...
            <h1 className="flex w-full text-center justify-center text-3xl font-medium mb-2">Welcome Back
            </h1>
            <h5 className="flex w-full text-blue-400 justify-center font-normal cursor-pointer hover:underline mb-2">
          ...
          <Fragment>
            ...
            <TextInput id="username" name="username" type="text"
              className={clsx("mt-2 mb-5 flex h-10 w-full items-center rounded border border-gray-300 pl-3 text-sm font-normal text-gray-600 focus:border focus:border-sky-500/50 focus:outline-none",
          ...
          <Fragment>
            ...
            <div className="relative mb-2 mt-2">
              ...
              <TextInput id="password" name="password" type={passwordType}
                className={clsx("flex h-10 w-full items-center rounded border border-gray-300 pl-3 text-sm font-normal text-gray-600 focus:border focus:border-sky-500/50 focus:outline-none",
          ...
          <Button type="submit" disabled={loading}
            className="bg-green-500 text-md block w-full cursor-pointer rounded px-8 py-2 text-center font-bold text-white hover:bg-green-400 focus:outline-none my-6"
