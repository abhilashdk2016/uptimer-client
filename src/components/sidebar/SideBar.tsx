...
const SideBar: FC<{ type: string}> = ({ type }): ReactElement => {
  ...
  return (
    <div className='h-[90%] w-full'>
        { type === 'sidebar' && <div className='text-gray-100 text-xl'>
                <div className='p-2 mt-1 flex items-center'>
                    <Link href={'/status'} className='relative z-10 px-2.5 flex items-center gap-2 cursor-pointer justify-center self-center text-2xl font-bold text-[#4aa1f3]'>
                        <FaTv />
                        Uptimer
                    </Link>
        ...
        <SidebarMenu 
            ...
            submenuTexts={
                [
                    ...
                    { name: 'New Uptime Test', onClick: openUptimeModel },
